...
Point.prototype =
/** @lends uki.geometry.Point.prototype */
{
...
Size.prototype =
/** @lends uki.geometry.Size.prototype */
{
  /**
...
Rect.prototype =
/** @lends uki.geometry.Rect.prototype */
{
  /**
  ...
  intersection: function (rect) {
    ...
    MAX(this.x, rect.x), MAX(this.y, rect.y)),
      size = new Size(
    MIN(this.maxX(), rect.maxX()) - origin.x, MIN(this.maxY(), rect.maxY()) - origin.y);
  ...
  union: function (rect) {
    ...
    MIN(this.x, rect.x), MIN(this.y, rect.y), MAX(this.maxX(), rect.maxX()), MAX(this.maxY(), rect.maxY()));
  },
...
Rect.fromCoords = function (minX, minY, maxX, maxY) {
  if (maxX === undefined) {
    return new Rect(
    minX.x, minX.y, minY.x - minX.x, minY.y - minX.y);
  }
...
Rect.create = function (a1, a2, a3, a4) {
  ...
  if (/\S+\s+\S+/.test(a1 + '')) {
    return Rect.fromString(a1, a2);
  }
  if (a3 === undefined) {
    return new Rect(a1, a2);
  }
...
Inset.prototype =
/** @lends uki.geometry.Inset.prototype */
{
...
Inset.create = function (a1, a2, a3, a4) {
  ...
  if (/\S+\s+\S+/.test(a1 + '')) {
    return Inset.fromString(a1, a2);
  }
  if (a3 === undefined) {
    return new Inset(a1, a2);
  }
