  ...
  uki.theme.aristo = uki.extend({}, uki.theme.Base, {
    ...
    backgrounds: {
      ...
      'button-focus': function () {
        if (uki.image.needAlphaFix) {
          return new uki.background.CssBox('filter:progid:DXImageTransform.Microsoft.Blur(pixelradius=3);background:#7594D2;', {
            inset: '-5 -5 -4 -5',
            zIndex: -2
          });
        }
      ...
      'shadow-big': function () {
        return new uki.background.Sliced9(shadowData(), "23 23 23 23", {
          zIndex: -2,
          inset: '-4 -10 -12 -10'
        });
      },
    ...
    images: {
      ...
      'radio-focus': function () {
        if (uki.image.needAlphaFix) {
          return uki.theme.aristo.image('checkbox-focus');
        }
