...
uki.view.declare('uki.more.view.SplitTable', uki.view.Container, function (Base) {
  ...
  this.columns = uki.newProp('_columns', function (c) {
    ...
    for (var i = 1; i < this._columns.length; i += 1) {
  ...
  this.rowHeight = function (value) {
    if (value === undefined) {
      return this._leftList.rowHeight();
    }
  ...
  this.data = function (d) {
    if (d === undefined) {
      return uki.map(this._leftList.data(), function (value, i) {
